...
// Generated Jul 26, 2015 8:06:39 PM by Hibernate Tools 4.3.1
 ...
 */
@Entity
@Table(name = "PATH_CLIENT_VETERAN_INFO")
public class PathClientVeteranInfo implements java.io.Serializable {
	...
	@GenericGenerator(name="UseExistingOrGenerateIdGenerator",
		strategy="org.openhmis.domain.UseExistingOrGenerateIdGenerator")
	@GeneratedValue(strategy = IDENTITY, generator="UseExistingOrGenerateIdGenerator")
