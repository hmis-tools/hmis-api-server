...
{
	public Boolean addClient(Client client) throws ClientAlreadyExistException, InValidClientException;																											// add a new client in the database
	public Boolean updateClient(Client client);																										// update an existing client in the database
	...
	public Client getClientById(Integer clientKey) throws ClientNotFoundException;																	// search a client by Id
