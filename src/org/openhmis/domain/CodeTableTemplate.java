...
/**
 * CodeTableTemplate entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "CODE_TABLE_TEMPLATE", catalog = "OPENHMIS2")
public class CodeTableTemplate implements java.io.Serializable {
	...
	/** default constructor */
	public CodeTableTemplate() {
	}

	/** minimal constructor */
	public CodeTableTemplate(Timestamp logDateTime) {
		this.logDateTime = logDateTime;
	}

	/** full constructor */
	public CodeTableTemplate(String description, String shortDesc,
