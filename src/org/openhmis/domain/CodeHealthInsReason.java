...
/**
 * CodeHealthInsReason entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "CODE_HEALTH_INS_REASON", catalog = "OPENHMIS2")
public class CodeHealthInsReason implements java.io.Serializable {
	...
	/** default constructor */
	public CodeHealthInsReason() {
	}

	/** minimal constructor */
	public CodeHealthInsReason(Timestamp logDateTime) {
		this.logDateTime = logDateTime;
	}

	/** full constructor */
	public CodeHealthInsReason(String description, String shortDescription,
