...
public class ClientVO 
{
	...
	public ClientVO(Long clientKey, String nameMiddle, String nameLast,
			...
			String socSecNumber, Integer dobTypeCode, Date dateOfBirth,
			Integer ethnicityCode, Integer genderCode,
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((ethnicityCode == null) ? 0 : ethnicityCode.hashCode());
		result = prime * result
	...
	public boolean equals(Object obj) {
		...
		if (ethnicityCode == null) {
			if (other.ethnicityCode != null)
				return false;
		} else if (!ethnicityCode.equals(other.ethnicityCode))
			return false;
		if (genderCode == null) {
